...
- Recién abierta (`lib/apertura-badge.ts`, Javier 2026-09-15): **máx 3 días** desde `fecha_apertura_inscripcion` (Europe/Madrid). Día 0 **Abierta hoy**; 1 **Abierta ayer**; 2–3 **🔥 ¡RECIÉN ABIERTA!**; ≥4 o sin fecha → sin badge / fuera del strip. No usar etiquetas ni el boolean `recien_abierta` si contradicen la fecha. El strip Recién abiertas **no espera** embargo VIP+24h. Embargo VIP+24h (`lib/highlight-embargo.ts`) sigue ocultando hero/carrusel/quincena.
